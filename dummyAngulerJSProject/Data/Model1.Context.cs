...
namespace dummyAngulerJSProject.Data
{
    ...
    public partial class ProjectDBEntities : DbContext
    {
        ...
        public virtual int SP_GenerateAllocationListReport(Nullable<System.DateTime> p_FromDate, Nullable<System.DateTime> p_ToDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GenerateAllocationListReport", p_FromDateParameter, p_ToDateParameter);
        }
    
        public virtual int SP_GenerateAuditTrailRpt(Nullable<int> p_ReportType, Nullable<System.DateTime> p_FromDate, Nullable<System.DateTime> p_ToDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GenerateAuditTrailRpt", p_ReportTypeParameter, p_FromDateParameter, p_ToDateParameter);
        }
    
        public virtual int SP_GenerateBranchListReport(Nullable<System.DateTime> p_FromDate, Nullable<System.DateTime> p_ToDate)
        {
            var p_FromDateParameter = p_FromDate.HasValue ?
                new ObjectParameter("p_FromDate", p_FromDate) :
                new ObjectParameter("p_FromDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GenerateBranchListReport", p_FromDateParameter, p_ToDateParameter);
        }
    
        public virtual int SP_GeneratePrinterListReport(Nullable<System.DateTime> p_FromDate, Nullable<System.DateTime> p_ToDate)
        {
            var p_FromDateParameter = p_FromDate.HasValue ?
                new ObjectParameter("p_FromDate", p_FromDate) :
                new ObjectParameter("p_FromDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GeneratePrinterListReport", p_FromDateParameter, p_ToDateParameter);
        }
    
        public virtual int SP_GenerateTicketsReport(Nullable<System.DateTime> p_FromDate, Nullable<System.DateTime> p_ToDate)
        {
            var p_FromDateParameter = p_FromDate.HasValue ?
                new ObjectParameter("p_FromDate", p_FromDate) :
                new ObjectParameter("p_FromDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GenerateTicketsReport", p_FromDateParameter, p_ToDateParameter);
        }
    
        public virtual int SP_GenerateUserManagementReport(Nullable<System.DateTime> p_FromDate, Nullable<System.DateTime> p_ToDate)
        {
            var p_FromDateParameter = p_FromDate.HasValue ?
                new ObjectParameter("p_FromDate", p_FromDate) :
                new ObjectParameter("p_FromDate", typeof(System.DateTime));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_GenerateUserManagementReport", p_FromDateParameter, p_ToDateParameter);
        }
